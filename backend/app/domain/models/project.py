...
class Project(Base, TimestampMixin):
    ...
    character_style_reference_prompt: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    scene_style_reference_prompt: Mapped[str | None] = mapped_column(Text, nullable=True)
